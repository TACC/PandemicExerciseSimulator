...
def test_InputSimulationProperties():
    ...
    assert ISP.vaccine_wastage_factor       == float(DATA['panflu']['params']['vaccine_wastage_factor'])
    assert ISP.antiviral_effectiveness      == float(DATA['panflu']['params']['antiviral_effectiveness'])
    assert ISP.antiviral_wastage_factor     == float(DATA['panflu']['params']['antiviral_wastage_factor'])
    ...
    assert ISP.relative_susceptibility_file == DATA['panflu']['data']['relative_susceptibility']
