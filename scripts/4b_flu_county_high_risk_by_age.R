...
# Population file generated by 1_county_age_pop_totals.R
acs_year_range = get0("ACS_YEAR_RANGE", ifnotfound = "2020-2024")

#### Data Sources #### <<<<<< Clarify these dates since they do not match the online metadata... 2024 completely ignored
# CDC PLACES 2025 release based on 2023 BRFSS with 2019-2023 ACS
# In the 2024 BRFSS Tennessee did not collect enough data to be included, but 2025 release does not mention using this dataset
...
# 2020-2024 ACS
county_pop = read_csv(paste0("../data/POPULATION/all_US_county_pop_by_age_", acs_year_range, "ACS.csv"))
