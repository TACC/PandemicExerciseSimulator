...
| 6b | `6b_derive_initial_infections.R` | Delaware manuscript example deriving county-age low-risk exposures and writing a generated `data/Delaware_TEST/INPUT_*.json`. |
